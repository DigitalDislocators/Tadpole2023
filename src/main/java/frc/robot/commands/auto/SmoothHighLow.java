...
public class SmoothHighLow extends SequentialCommandGroup {
    public SmoothHighLow(Drive drive, Rollers rollers, Arm arm) {
        super(
            ...
            new DriveStraightDistance(new State(-2.64, -0.5), 1.25, new Rotation2d(Math.PI), drive),
